								...
								<div class="inside">
									...
									<label>
										<input type="radio" class="wppd-ui-toggle" name="crawl_ophim_radio"
											value="ophim"
											<?php echo (json_decode(file_get_contents(CRAWL_OPHIM_PATH_SCHEDULE_JSON))->enable_ophim === true) ? 'checked' : ''; ?>> OPhim

									</label>
									<label>
										<input type="radio" class="wppd-ui-toggle" name="crawl_ophim_radio"
											value="kkphim"
											<?php echo (json_decode(file_get_contents(CRAWL_OPHIM_PATH_SCHEDULE_JSON))->enable_kkphim === true) ? 'checked' : ''; ?>> KKPhim

									</label>
									<label>
										<input type="radio" class="wppd-ui-toggle" name="crawl_ophim_radio"
											value="nguonc"
											<?php echo (json_decode(file_get_contents(CRAWL_OPHIM_PATH_SCHEDULE_JSON))->enable_nguonc === true) ? 'checked' : ''; ?>> Nguonc
